...
import { getAllTags, requestUrl }  from "obsidian";
import fs from "fs";
import copy from 'clipboard-copy';
import { marked } from 'marked';

//https://liamca.in/Obsidian/API+FAQ/commands/unload+a+Command
//https://luhaifeng666.github.io/obsidian-plugin-docs-zh/zh/api/classes/FileView.html#getstate

export default class PublishWorkPlugin extends Plugin {
  async onload() {
	//request
	// loadNotes();
...
function loadNotes(){
	//请求网络
	let api = 'https://notes.bluetech.top/api/download/history?t=1659140767096';
		api = 'https://notes.bluetech.top/api/user/extra?t=1659142800070&account=shuise';
    let requestParams = {
        headers: new Headers({
            "Content-Type": "application/json",
            'token': '3dad7d7ce4144f22ad32ab0074d79faf',
            'Cookie': 'userInfo={"id":"1522408916273405953","account":"shuise","createdAt":"2022-05-06 10:52:25","token":"ae7eb4af94de4c04a6bedce89d24bce4"}; Hm_lvt_4f2d8402fb6b0cb7227ec1d03b750df7=1658103142; Hm_lpvt_4f2d8402fb6b0cb7227ec1d03b750df7=1659140746'
        }),
        method: 'GET',
        credentials: 'include'
    };
	requestUrl(api, requestParams).then(function(response) {
        console.log('request back 1',response.json);
        response.json().then(function(result) {
            console.log('request back 2',result);
        })
    }).catch(function(e) {
    	console.log('request back ok', e);
    });
}
